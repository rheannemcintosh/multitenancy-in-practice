...
class TenantScopeTest extends TestCase
{
     ...
     * @test
     */
    public function test_a_user_can_only_create_a_user_in_their_tenant()
    {
        $tenant1 = Tenant::factory()->create();
        $tenant2 = Tenant::factory()->create();
     ...
     * @test
     */
    public function test_a_user_can_only_create_a_user_in_their_tenant_even_if_another_tenant_is_provided()
    {
        $tenant1 = Tenant::factory()->create();
        $tenant2 = Tenant::factory()->create();
